# Markerwadden Islands Shoreline Evolution

This repository is for the final assignment of the AESM5230C Coastal Remote Sensing project "Markerwadden Islands Shoreline Evolution"

**Authors:** Thunchanok Phutthaphaiboon and Josephine Winterdal
...
## Notes
- This online repository only includes the codes for analysis but does not contain the data files (too heavy). If there's any question, please contact the authors.
